...
HempDB checks four permissions instead of Group names:
...
Groups may bundle these permissions in any combination. Active Staff users
retain standard Django Admin access, and superusers receive all permissions.
